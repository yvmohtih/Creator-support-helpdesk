...
const issueCategories: Array<{
  ...
  },
  {
    ...
    nameTe: 'ఇతర సమస్య',
    descriptionEn: 'Any Instagram problem that does not match the listed categories.',
    descriptionTe: 'జాబితాలో లేని ఏదైనా Instagram సమస్య.',
    sortOrder: 70,
  },
  {
  ...
  {
    platform: Platform.facebook,
    nameEn: 'Page access problem',
    nameTe: 'పేజ్ యాక్సెస్ సమస్య',
    descriptionEn: 'Admin access or page role is missing.',
    descriptionTe: 'అడ్మిన్ యాక్సెస్ లేదా పేజ్ రోల్ కనిపించడం లేదు.',
    sortOrder: 60,
  },
  {
    platform: Platform.facebook,
    nameEn: 'Other problem',
    nameTe: 'ఇతర సమస్య',
    descriptionEn: 'Any Facebook problem that does not match the listed categories.',
    descriptionTe: 'జాబితాలో లేని ఏదైనా Facebook సమస్య.',
    sortOrder: 70,
  },
  {
  ...
  },
  {
    ...
    nameEn: 'Other problem',
    nameTe: 'ఇతర సమస్య',
    descriptionEn: 'Any YouTube problem that does not match the listed categories.',
    descriptionTe: 'జాబితాలో లేని ఏదైనా YouTube సమస్య.',
    sortOrder: 70,
  },
  {
    ...
    nameTe: 'ఖాతా సమస్య',
    descriptionEn: 'Account is blocked, missing, or not working.',
    descriptionTe: 'ఖాతా బ్లాక్ అయింది, కనిపించడం లేదు లేదా పనిచేయడం లేదు.',
    sortOrder: 10,
  },
  {
    platform: Platform.other,
    nameEn: 'Login problem',
    nameTe: 'లాగిన్ సమస్య',
    descriptionEn: 'User cannot open or access the account.',
    descriptionTe: 'వినియోగదారు ఖాతాను తెరవలేకపోతున్నారు లేదా యాక్సెస్ చేయలేకపోతున్నారు.',
    sortOrder: 20,
  },
  {
    platform: Platform.other,
    nameEn: 'Payment problem',
    nameTe: 'చెల్లింపు సమస్య',
    descriptionEn: 'Payment is delayed or not received.',
    descriptionTe: 'చెల్లింపు ఆలస్యం అయింది లేదా రాలేదు.',
    sortOrder: 30,
  },
  {
    platform: Platform.other,
    nameEn: 'Copyright problem',
    nameTe: 'కాపీరైట్ సమస్య',
    descriptionEn: 'Copyright warning, claim, or removal.',
    descriptionTe: 'కాపీరైట్ హెచ్చరిక, క్లెయిమ్ లేదా తొలగింపు.',
    sortOrder: 40,
  },
  {
    platform: Platform.other,
